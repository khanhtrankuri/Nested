...
def build_parser():
    ...
    parser.add_argument("--nested-start-epoch", type=int, default=15)
    parser.add_argument("--nested-dim", type=int, default=256)
    ...
    parser.add_argument("--nested-memory-hidden", type=int, default=256)
    ...
    parser.add_argument("--ms-tta-scales", type=float, nargs="+", default=[0.75, 0.825, 0.875, 1.0, 1.125, 1.25, 1.5])
    return parser
